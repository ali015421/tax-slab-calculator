DAY 1: starting to practically play around with python, chose tax slab 
calculator since most of Pakistani awam doesn't even know what taxes are
...
- Biggest challenge was turning the tax slab ratios/percentages into actual 
  working formulas in code, translating "11% of amount exceeding 1,200,000" 
  into (income-1200000)/100*11 wasn't obvious at first
- Copy-pasted bracket 3's formula into bracket 2's branch by mistake, caught 
  it by comparing each branch against the table again
